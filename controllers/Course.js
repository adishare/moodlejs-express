...
module.exports = {
    ...
    async searchRecords(req, res){
        ...
        switch(options.field){
            ...
            default:{
                console.error('Searching on Course with incorrect field: ' + options.field);
    ...
    async paginatedList(res, options){
        try {
            ...
            console.error('Paginated search on Course with error: ' + error);
    ...
    async paginatedLike(res, options) {
        try {
            ...
            console.error('Paginated like search on Course with error: ' + error);
    ...
    async createRecord(req, res) {
        ...
        try {
            ...
            console.error('Create on Course with error: ' + error);
    ...
    async updateRecord(req, res) {
        try {
            ...
            console.error('Update on Course with error: ' + error);
    ...
    async readRecord(req, res) {
        try {
            ...
            console.error('Read on Course with error: ' + error);
    ...
    async listAll(req, res) {
        try {
            ...
            console.error('List on Course with error: ' + error);
            return res.status(500).send({ error: true, message: 'Your search could not be completed.' });
        }
    },
    ...
    async deleteRecord(req, res) {
        try {
            ...
            console.error('Delete on Course with error: ' + error);
